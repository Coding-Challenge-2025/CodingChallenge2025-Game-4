        ...
        import("monaco-editor").then((monaco) => {
            ...
            if (language === "python") {
                monaco.languages.setLanguageConfiguration("python", {
                    indentationRules: {
                        increaseIndentPattern: /^\s*(def|class|for|if|elif|else|while|try|with|finally|except|async).*[:(]/,
                        decreaseIndentPattern: /^\s*(pass|return|raise|break|continue|else|elif)/,
                    },
                });
            }
